...
namespace BenzinOtomasyonuProje
{
    public partial class Form1 : Form
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (comboBox1.Text == "BENZİN(97)")
            {
            ...
            else if (comboBox1.Text == "EURODİZEL")
            {
                numericUpDown1.Enabled = false;
                numericUpDown2.Enabled = false;
                numericUpDown3.Enabled = false;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            System.IO.File.WriteAllLines(Application.StartupPath + "\\FİYAT.txt", fiyat_bilgileri);
            txt_fiyat_oku();
            txt_fiyat_yaz();
        }
        ...
        {
            fiyat_bilgileri = System.IO.File.ReadAllLines(Application.StartupPath + "\\FİYAT.txt");
